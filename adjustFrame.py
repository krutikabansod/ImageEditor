...
class AdjustFrame(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.contrast_label = Label(self, text="Contrast",bg="violetred1")
        self.contrast_scale = Scale(self, from_=0, to_=255, length=250, resolution=1,
                                       orient=HORIZONTAL)
        self.brightness_label = Label(self, text="Brightness",bg="violetred1")
        ...
        #                               orient=HORIZONTAL)
        self.clarity_label = Label(self, text="Blur",bg="violetred1")
        self.clarity_scale = Scale(self, from_=0, to_=2, length=250, resolution=0.1,
                                    orient=HORIZONTAL)
        self.warmth_label = Label(self, text="Warmth",bg="violetred1")
        self.warmth_scale = Scale(self, from_=0, to_=1, length=250, resolution=0.05,
                                   orient=HORIZONTAL)
        self.cool_label = Label(self, text="Cool",bg="violetred1")
        self.cool_scale = Scale(self, from_=0, to_=1, length=250, resolution=0.05,
                                  orient=HORIZONTAL)



        self.r_label = Label(self, text="R",bg="violetred1")
        self.r_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
        self.g_label = Label(self, text="G",bg="violetred1")
        self.g_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
        self.b_label = Label(self, text="B",bg="violetred1")
        self.b_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
                                                 
        self.apply_button = Button(self, text="Apply",width=15,bg="plum1")
        self.preview_button = Button(self, text="Preview",width=15,bg="plum1")
        self.cancel_button = Button(self, text="Cancel",width=15,bg="plum1")
