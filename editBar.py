...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.new_button = Button(self, text="New",bg="plum1",width="10",height="2")
        self.save_button = Button(self, text="Save",bg="plum1",width="10",height="2")
        self.save_as_button = Button(self, text="Save As",bg="plum1",width="10",height="2")
        self.draw_button = Button(self, text="Draw",bg="plum1",width="10",height="2")
        self.crop_button = Button(self, text="Crop",bg="plum1",width="10",height="2")
        self.mirror_button = Button(self, text="Mirror",bg="plum1",width="10",height="2")
        self.rotate_button = Button(self, text="Rotate",bg="plum1",width="10",height="2")
        self.filter_button = Button(self, text="Filter",bg="plum1",width="10",height="2")
        self.adjust_button = Button(self, text="Adjust",bg="plum1",width="10",height="2")
        self.clear_button = Button(self, text="Clear",bg="plum1",width="10",height="2")
