...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        Toplevel.__init__(self, master=master,bg="violetred1")

        self.original_image = self.master.processed_image
        self.filtered_image = None

        self.negative_button = Button(master=self, text="Negative",width=10,bg="plum1")
        self.black_white_button = Button(master=self, text="Black White",width=10,bg="plum1")
        self.sepia_button = Button(master=self, text="Sepia",width=10,bg="plum1")
        self.emboss_button = Button(master=self, text="Emboss",width=10,bg="plum1")
        self.gaussian_blur_button = Button(master=self, text="Gaussian Blur",width=10,bg="plum1")
        self.median_blur_button = Button(master=self, text="Median Blur",width=10,bg="plum1")
        self.details_button = Button(master=self, text="Details",width=10,bg="plum1")
        self.summer_button = Button(master=self, text="Summer",width=10,bg="plum1")
        self.winter_button = Button(master=self, text="Winter",width=10,bg="plum1")
        self.daylight_button = Button(master=self, text="DayLight",width=10,bg="plum1")
        self.grainy_button = Button(master=self, text="Grainy",width=10,bg="plum1")
        self.highcontrast_button=Button(master=self,text="High Contrast",width=10,bg="plum1")
        self.smoothen_button = Button(master=self, text="Smoothen",width=10,bg="plum1")
        self.vignette_button = Button(master=self, text="Vignette",width=10,bg="plum1")
        self.bonus_button = Button(master=self, text="Bonus",width=10,bg="plum1")
        self.distorted_button = Button(master=self, text="Distorted",width=10,bg="plum1")
        self.cancel_button = Button(master=self, text="Cancel",width=10,bg="plum1")
        self.apply_button = Button(master=self, text="Apply",width=10,bg="plum1")
        self.details_button=Button(master=self,text="Details",width=10,bg="plum1")
    ...
    def bonus(self):
        dst = cv2.stylization(self.original_image, sigma_s=40, sigma_r=0.03)
